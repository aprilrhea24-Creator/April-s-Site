      ...
      <div className="mt-8 grid gap-5">
        {projects.length ? (
          projects.map((project) => (
            <article key={project.id} className="glass-panel grid gap-5 rounded-[2rem] p-6 md:grid-cols-[1fr_auto] md:items-center">
              <div>
                ...
                <div className="mt-4 h-2 max-w-xl rounded-full bg-white/10">
                  <div
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-cyan-200/30 bg-cyan-100 px-5 py-3 font-semibold text-slate-950 hover:bg-white"
              >
                Open Portal
