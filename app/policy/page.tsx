...
export default function PolicyPage() {
  return (
    <div className="bg-[#07080a] text-white">
      <section className="bg-[radial-gradient(circle_at_80%_10%,rgba(240,6,18,0.2),transparent_28%),#07080a] px-4 py-20 sm:px-6 lg:px-10">
        <div className="mx-auto max-w-[1560px]">
          <SectionTitle
            eyebrow="Chef Thai Catering Policy"
            title="EXPECTATIONS BEFORE YOUR EVENT"
            description="Please review these policies before placing a catering or event order."
            tone="dark"
          />
