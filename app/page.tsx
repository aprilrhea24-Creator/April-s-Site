...
export default function HomePage() {
  return (
    <div className="relative overflow-hidden bg-[linear-gradient(180deg,#000000_0%,#070a10_56%,#000000_100%)]">
      ...
      <div className="relative isolate -mt-20 overflow-hidden bg-[linear-gradient(180deg,rgba(5,5,8,0)_0%,rgba(5,5,8,0.74)_10rem,#000000_22rem)] pt-20">
        <BreathingBackground fixed={false} transparentBase viewportBound />
